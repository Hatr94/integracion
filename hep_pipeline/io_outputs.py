...
def save_datasets(workflow, all_datasets, n_events):
    ...
    for cfg_key, payload in all_datasets.items():
        ...
        meta = {
            ...
            "notes": {
                ...
                "hardness_proxy": "Not exactly equivalent a PhaseSpace:pTHatMin de Pythia-only; it is max pT of a relevant parton",
    ...
    with open(readme_path, "w") as f:
        ...
        f.write(f"Minimum jet pT: {workflow.jet_pt_min} GeV\n")
